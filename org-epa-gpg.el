...
(defun org-epa-gpg-dedup-exts()
  ...
  (delete-dups
   (append image-file-name-extensions
           (mapcar (lambda (el) (format (concat "%s." org-epa-gpg-ext) el))
